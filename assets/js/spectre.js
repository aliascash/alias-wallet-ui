...
function formatTransaction(tx) {
    if (Array.isArray(tx)) {
        ...
        return "<tr id='" + o.id + "'"+ ((tx.length === 1) ? " data-title='" + o.tt + "'" : "") + ">"+
            ...
            "<td class='trans-type'" + ((tx.length > 1) ? " data-title='" + tooltipStatus + "'" : "") + "><img height='15' width='15' src='assets/icons/tx_" + o.t + ".png' /> " + o.t_l + " <b>(x" + tx.length + ")</b></td>"+
        ...
        return "<tr id='" + o.id + "' data-title='" + o.tt + "'>"+
            ...
            "<td class='trans-type'><img height='15' width='15' src='assets/icons/tx_" + o.t + ".png' /> " + o.t_l + "</td>"+
